...
def weighted_unnormalized_softmax_cross_entropy(
    ...
    perform_reduction: bool = True) -> jnp.ndarray:
  ...
  Args:
    ...
    perform_reduction: If True, reduce the logit dimension of the output loss.
...
def focal_softmax_cross_entropy(
  ...
  Args:
    ...
    perform_reduction: If True, reduce the logit dimension.
